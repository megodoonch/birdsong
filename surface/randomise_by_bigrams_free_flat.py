...
""" Here we generate corpora using bigrams of the actually observed sentences,
but we do not impose any length restrictions on the words: we just generate them as they come.
Furthermore, all bigrams are artificially made to be equally likely.
"""
...
OUTPUT_DIR = "./output/bigramgen-free-flat/"
...
corpus_stats.to_csv('interim/bigramgen_free_flat_corpus_stats.csv')
